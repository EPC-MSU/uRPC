    ...
    def __getitem__(self, uid):
        ...
        if not item.project:
            ...
            if isfile(path) and access(path, R_OK):
                ...
                item.project = Protocol(name="default_project", version="0.0.1", product_name="Default product name", device_name="Default device name", pid="0x1234", vid="0x5678", manufacturer="Acme Corporation")
