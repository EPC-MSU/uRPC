...
class Argument(AstNode):
    def __init__(self, type, name, description=None, consts=None, extra_options=None, parent=None,  # noqa: A002
                 uid=None):
        super().__init__(
            props={"type": type, "name": name},
            children=consts,
            description=description,
            extra_options=extra_options,
            parent=parent,
...
class Message(AstNode):
    ...
    # def __repr__(self):
    #     return ", ".join(str(a) for a in self.arguments.values())
