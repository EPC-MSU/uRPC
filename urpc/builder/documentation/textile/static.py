def get_static_part():
    ...
    h2. Обработка ошибок на стороне контроллера

    h3. Неверные команды или данные
    ...
    *Изменение байта на стороне компьютера*
    ...
    h3. Восстановление синхронизации методом таймаута
    ...
    h3. Восстановление синхронизации методом очистительных нулей
    ...
    h2. Обработка ошибок на стороне библиотеки
    ...
    h3. Возможные значения ответа библиотеки
    ...
    * @result_nodevice@. Невозможность открытия устройства, потеря связи с ним в процессе передачи данных, неудачная \
    ...
    h3. Процедура синхронизации очистительными нулями
