...
_lookup = mako.lookup.TemplateLookup((join(_module_path, "static"),), input_encoding="utf-8", output_encoding="utf-8")
...
def build(project, output):
    ...
    def import_file(filename):
        # fix for #16202. TODO: refactor. Don't use Mako templates at all.
        from platform import system
        if system().lower() == "windows":
            return join("tango", filename)
        return filename

    subdir_path = join(_module_path, "static")
