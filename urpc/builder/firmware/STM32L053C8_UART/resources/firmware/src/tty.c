...
#define TTY_PORT_CLK  LL_IOP_GRP1_PERIPH_GPIOA
#define TTY_RX_PIN    LL_GPIO_PIN_10
#define TTY_RX_AF     LL_GPIO_AF_4
#define TTY_TX_PIN    LL_GPIO_PIN_9
#define TTY_TX_AF     LL_GPIO_AF_4
...
#define TTY_DMA_REQ   LL_DMA_REQUEST_3
#define TTY_RX_CHAN   LL_DMA_CHANNEL_5
#define TTY_RX_IRQ    DMA1_Channel4_5_6_7_IRQn
#define TTY_TX_CHAN   LL_DMA_CHANNEL_4
#define TTY_TX_IRQ    DMA1_Channel4_5_6_7_IRQn
...
void TTY_Init(void)
{
  ...
  LL_IOP_GRP1_EnableClock(TTY_PORT_CLK);
   ...
   */
  DMA_InitStructure.PeriphOrM2MSrcAddress   = LL_USART_DMA_GetRegAddr(TTY_UART, LL_USART_DMA_REG_DATA_RECEIVE);
  ...
  DMA_InitStructure.PeriphRequest           = TTY_DMA_REQ;
   ...
   */
  DMA_InitStructure.PeriphOrM2MSrcAddress = LL_USART_DMA_GetRegAddr(TTY_UART, LL_USART_DMA_REG_DATA_TRANSMIT);
